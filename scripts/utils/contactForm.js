import { getId, filterPhotographers } from "../pages/photographer.js";
// concerver le target dans la modal
function trapFocus(element) {
  var focusableEls = element.querySelectorAll(
    "a[href], button, textarea, input, input, input, select"
  );
...
//met le nom du photographe dans la modal de contact
